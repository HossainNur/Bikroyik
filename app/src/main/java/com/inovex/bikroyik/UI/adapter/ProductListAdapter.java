...
public class ProductListAdapter extends RecyclerView.Adapter<ProductListAdapter.ProductListViewHolder> {
    private static ProductListAdapter adapter = null;
    ...
    public static ProductListAdapter getInstance(){
        if (adapter == null){
    ...
    protected class ProductListViewHolder extends RecyclerView.ViewHolder {
        TextView expandedItemTextOne, expandedItemTextTwo, expandedItemTextThree, expandedItemTextFour;
        ImageView ivProduct;
