...
import com.inovex.bikroyik.UI.fragments.FragmentStock;
import com.inovex.bikroyik.UI.fragments.ProductFragment;
...
public class OrderItemActivity extends AppCompatActivity implements SharedCallback{
    ...
    private TextView tittle_ett,chargeText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreference = SharedPreference.getInstance(OrderItemActivity.this);
...
//                mOrderViewModel.queryForAllOrderData();
        ...
        orderActivityViewModel.getOrderedProductList().observe(OrderItemActivity.this, new Observer<OrderJsonModel>() {
            @Override
...
//                }
        ...
        llBtnTotalCharge.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(OrderItemActivity.this, MakePaymentActivity.class);
        ...
        mProductViewModel.getAllCategory().observe(OrderItemActivity.this, new Observer<List<String>>() {
            @Override
        ...
        mProductViewModel.getProductData().observe(OrderItemActivity.this, new Observer<List<ProductModel>>() {
            @Override
            public void onChanged(List<ProductModel> productModelList) {
...
//                mAdapter.notifyDataSetChanged();
        ...
        mProductViewModel.isProductButtonClicked().observe(OrderItemActivity.this, new Observer<Boolean>() {
            @Override
...
//                    setAdapter(mContext, callback, callbackOrderItem);
    ...
    private void setPortraitModeButtonActivity(){
        ...
        orderActivityViewModel.getTotalChargeLiveData().observe(OrderItemActivity.this, new Observer<String>() {
            @Override
            ...
            public void onChanged(String barcode) {
                if (!TextUtils.isEmpty(barcode) && !barcode.equals("0000000")){
                    ...
                    if (productModel != null){
                        ...
                        if(ProductFragment.currentCategorySelectedPosition == 0) {
...
//                        orderActivityViewModel.setProductCategorySelectedPosition(position);
                            mProductViewModel.getProductByCategory(String.valueOf(ProductFragment.currentCategorySelectedPosition));
                        }
                    }
        ...
        btn_salesItem.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(OrderItemActivity.this, TotalChargeCalculationActivity.class);
                startActivity(intent);
            }
        });
