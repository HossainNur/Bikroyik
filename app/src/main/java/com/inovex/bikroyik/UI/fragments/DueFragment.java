...
import com.inovex.bikroyik.UI.adapter.DueListAdapter;
...
public class DueFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_due2, container, false);
        init(view);
        getServerData();
        return view;
    }
    ...
    private void init(View view){
        recyclerView = view.findViewById(R.id.dueFragment);
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            dueListAdapter = new DueListAdapter(getContext(),arrayList);
                            recyclerView.setAdapter(dueListAdapter);
