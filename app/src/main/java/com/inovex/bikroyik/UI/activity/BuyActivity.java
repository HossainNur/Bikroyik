...
public class BuyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProgressDialog csprogress=new ProgressDialog(BuyActivity.this);
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(expenseAmount.getText().toString())){
                    buyModel.setAmount(Integer.parseInt(expenseAmount.getText().toString()));
                }else {
                    flag = true;
                ...
                if (!TextUtils.isEmpty(expenseNote.getText().toString())){
                    buyModel.setNote(expenseNote.getText().toString());
                }else {
                    flag = true;
                ...
                if (!flag){
                    ...
                    buyModel.setExpenseType("Purchase");

                    if (imageName !=null && currentPhotoPath != null){
                        buyModel.setImage(imageName);
                    }
                    if (!TextUtils.isEmpty(dateButton.getText().toString())){
                        buyModel.setDate(dateButton.getText().toString());
                    }else {
                        buyModel.setDate("");
                    }


                    buyModel.setStoreId(sharedPreference.getStoreId());
                    buyModel.setSubscriberId(sharedPreference.getSubscriberId());
                    buyModel.setSubmittedBy(sharedPreference.getUserId());


                    sendClientInfoToServer(getApplicationContext(), ApiConstants.EXPENSE, buyModel);
...
//whatever you want just you have to launch overhere.
                    ...
                    //Toast.makeText(BuyActivity.this,"Expense added Successfully",Toast.LENGTH_SHORT).show();
        ...
        expenseImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PopupMenu popupMenu = new PopupMenu(BuyActivity.this, expenseImage);
    ...
    private String prepareJson(BuyModel buyModel){
        Gson gson = new GsonBuilder().serializeNulls().create();

        return gson.toJson(buyModel);
    }
...
//            }
    ...
    private void sendClientInfoToServer(Context context, String url, BuyModel buyModel){
        VolleyMethods volleyMethods = new VolleyMethods();
        String reqBody = prepareJson(buyModel);
        Log.d("_tag_", "json: "+reqBody);

        volleyMethods.sendPostRequestToServer(context, url, prepareJson(buyModel), new VolleyCallBack() {
            @Override
            public void onSuccess(String result) {
                ...
                if (!TextUtils.isEmpty(result) && "error".equals(result)){
                    ...
                    Toasty.success(BuyActivity.this, "Expense added Successfully!", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(BuyActivity.this, Expense.class);
                    startActivity(intent);
                }
                else{

                    Toasty.error(BuyActivity.this,"Server Error",Toast.LENGTH_SHORT).show();
                }
