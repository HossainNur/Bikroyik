...
public class DueAdapter extends RecyclerView.Adapter<DueAdapter.MyViewHolder> {
    private static DueAdapter dueAdapter = null;
    private List<DueData> list;
    private Context mContext;
    private DueClientCallback dueClientCallback;

    public static DueAdapter getInstance(){
        if (dueAdapter == null){
    ...
    public void init(Context context, List<DueData> list, DueClientCallback dueClientCallback){
        this.mContext = context;
        this.list = list;
        this.dueClientCallback = dueClientCallback;
    }
