...
import com.inovex.bikroyik.UI.fragments.FragmentProductList;
...
public class ProductListActivity extends AppCompatActivity implements SharedCallback{
    ...
    private NewProductGridAdapter newProductGridAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreference = SharedPreference.getInstance(ProductListActivity.this);
        ...
        {
            toolbar_title.setText("পণ্য লিস্ট ");
        }
        commonElement();
...
//        mSalesViewModel.queryForGetAllProductData(this);
    ...
    private void initPortrait(){
        ...
        /*newProductGridAdapter = new NewProductGridAdapter(getApplicationContext(),arrayList);
        recyclerView = (RecyclerView) findViewById(R.id.productList_recycler_products_grid);
        recyclerView.setHasFixedSize(true);
        GridLayoutManager layoutManager = new GridLayoutManager(getApplicationContext(),GridLayoutManager.VERTICAL,false);
        recyclerView.setLayoutManager(layoutManager);
        arrayList = new ArrayList<ProductModel>();
        recyclerView.setAdapter(newProductGridAdapter);*/
...
//                mOrderViewModel.queryForAllOrderData();
        ...
        orderActivityViewModel.getOrderedProductList().observe(ProductListActivity.this, new Observer<OrderJsonModel>() {
            @Override
...
//                }
        ...
        llBtnTotalCharge.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ProductListActivity.this, MakePaymentActivity.class);
        ...
        mProductViewModel.getAllCategory().observe(ProductListActivity.this, new Observer<List<String>>() {
            @Override
        ...
        mProductViewModel.getProductData().observe(ProductListActivity.this, new Observer<List<ProductModel>>() {
            @Override
            public void onChanged(List<ProductModel> productModelList) {
...
//                mAdapter.notifyDataSetChanged();
        ...
        mProductViewModel.isProductButtonClicked().observe(ProductListActivity.this, new Observer<Boolean>() {
            @Override
...
//                    setAdapter(mContext, callback, callbackOrderItem);
    ...
    /*private void setPortraitModeButtonActivity(){
        ...
        orderActivityViewModel.getTotalChargeLiveData().observe(ProductListActivity.this, new Observer<String>() {
            @Override
            ...
            public void onChanged(String barcode) {
                if (!TextUtils.isEmpty(barcode) && !barcode.equals("0000000")){
                    ...
                    if (productModel != null){
                        ...
                        if(FragmentProductList.currentCategorySelectedPosition == 0) {
...
//                        orderActivityViewModel.setProductCategorySelectedPosition(position);
                            mProductViewModel.getProductByCategory(String.valueOf(FragmentProductList.currentCategorySelectedPosition));
                        }
                    }
        ...
        btn_salesItem.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ProductListActivity.this, TotalChargeCalculationActivity.class);
                startActivity(intent);
            }
        });
