...
public class OrderActivity extends AppCompatActivity implements SharedCallback{
...
//    List<String> categoryList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreference = SharedPreference.getInstance(OrderActivity.this);
...
//        mSalesViewModel.queryForGetAllProductData(this);
    ...
    private void initLandScope() {
        ...
        PartSpinner=(Spinner) findViewById(R.id.spinnerId);
    ...
    private void initPortrait(){
        tv_charge = (TextView) findViewById(R.id.chargeText);
...
//                mOrderViewModel.queryForAllOrderData();
        ...
        orderActivityViewModel.getOrderedProductList().observe(OrderActivity.this, new Observer<OrderJsonModel>() {
            @Override
...
//                }
        ...
        llBtnTotalCharge.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(OrderActivity.this, MakePaymentActivity.class);
        ...
        mProductViewModel.getAllCategory().observe(OrderActivity.this, new Observer<List<String>>() {
            @Override
        ...
        mProductViewModel.getAllProductName().observe(OrderActivity.this, new Observer<List<String>>() {
            @Override
            public void onChanged(List<String> productList) {
                // strings.add(0,"All Items");
                //productNameList = strings;
                //productList.add(0,"all value");
                //categorySpinner(categoryList);
                productSpinner(productList);
            }
        });



        mProductViewModel.getProductData().observe(OrderActivity.this, new Observer<List<ProductModel>>() {
            @Override
            public void onChanged(List<ProductModel> productModelList) {
...
//                mAdapter.notifyDataSetChanged();
        ...
        mProductViewModel.isProductButtonClicked().observe(OrderActivity.this, new Observer<Boolean>() {
            @Override
...
//                    setAdapter(mContext, callback, callbackOrderItem);
    ...
    private void setPortraitModeButtonActivity(){
        ...
        orderActivityViewModel.getTotalChargeLiveData().observe(OrderActivity.this, new Observer<String>() {
            @Override
            public void onChanged(String s) {

                Double grandValue = Double.valueOf(s);
                DecimalFormat df = new DecimalFormat("#.##");

               // tv_total_price_sales.setText(s);
                tv_total_price_sales.setText(df.format(grandValue));
            }
        });
        ...
        orderActivityViewModel.getOrderedProductList().observe(this, new Observer<OrderJsonModel>() {
            ...
            public void onChanged(OrderJsonModel orderJsonModel) {
                if (orderJsonModel != null){
                    ...
                    Double grandValue = orderJsonModel.getGrandTotal();
                    DecimalFormat df = new DecimalFormat("#.##");
                    //String.valueOf(orderJsonModel.getGrandTotal())
                    tv_total_price_sales.setText(df.format(grandValue));
                }else {
            ...
            public void onChanged(String barcode) {
                if (!TextUtils.isEmpty(barcode) && !barcode.equals("0000000")){
                    ...
                    if (productModel != null){
                        ...
                        if(FragmentProducts.currentCategorySelectedPosition == 0) {
...
//                        orderActivityViewModel.setProductCategorySelectedPosition(position);
                            mProductViewModel.getProductByCategory(String.valueOf(FragmentProducts.currentCategorySelectedPosition));
                        }
                    }
        ...
        btn_salesItem.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(OrderActivity.this, TotalChargeCalculationActivity.class);
...
//                    mSalesViewModel.getProductByCategory(itemList.get(position));
    ...
    private void productSpinner(List<String> productList){

        ArrayAdapter spinner = new ArrayAdapter(mContext, R.layout.spinner_layout, productList);
        spinner.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        ...
        PartSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if(position == 0) {
                    mProductViewModel.getProductName(productList.get(position));
                }
                else {
                    mProductViewModel.getProductName(productList.get(position));
                }
