...
public final class FragmentProduct3Binding implements ViewBinding {
  @NonNull
  ...
  private FragmentProduct3Binding(@NonNull FrameLayout rootView, @NonNull ImageView btnScan,
  ...
  @NonNull
  public static FragmentProduct3Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentProduct3Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_product3, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentProduct3Binding bind(@NonNull View rootView) {
    // The body of this method is generated in a way you would not otherwise write.
    // This is done to optimize the compiled bytecode for size and performance.
    int id;
    missingId: {
      id = R.id.btn_scan;
      ImageView btnScan = rootView.findViewById(id);
      if (btnScan == null) {
        break missingId;
      }
      ...
      return new FragmentProduct3Binding((FrameLayout) rootView, btnScan,
          productListRecyclerProducts, productListRecyclerProductsGrid, searchBox, spinnerId,
          spinnerSales);
    }
