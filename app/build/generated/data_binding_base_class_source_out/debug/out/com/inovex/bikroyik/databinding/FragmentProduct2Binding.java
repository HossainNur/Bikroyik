...
public final class FragmentProduct2Binding implements ViewBinding {
  @NonNull
  ...
  private FragmentProduct2Binding(@NonNull FrameLayout rootView,
  ...
  @NonNull
  public static FragmentProduct2Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentProduct2Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_product2, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentProduct2Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentProduct2Binding((FrameLayout) rootView, productListRecyclerProducts,
