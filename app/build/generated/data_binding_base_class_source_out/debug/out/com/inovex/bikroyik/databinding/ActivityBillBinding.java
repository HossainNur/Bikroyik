...
public final class ActivityBillBinding implements ViewBinding {
  ...
  @NonNull
  public final ToolbarBillBinding toolbar1;

  private ActivityBillBinding(@NonNull RelativeLayout rootView,
      @NonNull RelativeLayout activityBill, @NonNull ImageView addExpenseImage,
      ...
      @NonNull ToolbarBillBinding toolbar1) {
  ...
  public static ActivityBillBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ToolbarBillBinding binding_toolbar1 = ToolbarBillBinding.bind(toolbar1);

      return new ActivityBillBinding((RelativeLayout) rootView, activityBill, addExpenseImage,
          datePickerButton, etExpenseAmount, etExpenseNote, expenseAmount, expenseAmount1,
          expenseNote, expenseNote1, savebtnId, textView, binding_toolbar1);
    }
