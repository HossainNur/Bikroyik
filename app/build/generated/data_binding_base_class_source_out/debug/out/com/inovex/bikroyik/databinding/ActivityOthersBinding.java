...
public final class ActivityOthersBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final ToolbarOthersBinding toolbar1;

  private ActivityOthersBinding(@NonNull RelativeLayout rootView,
      ...
      @NonNull TextView textView, @NonNull ToolbarOthersBinding toolbar1) {
  ...
  @NonNull
  public static ActivityOthersBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityOthersBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_others, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityOthersBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ToolbarOthersBinding binding_toolbar1 = ToolbarOthersBinding.bind(toolbar1);

      return new ActivityOthersBinding((RelativeLayout) rootView, addExpenseImage, datePickerButton,
