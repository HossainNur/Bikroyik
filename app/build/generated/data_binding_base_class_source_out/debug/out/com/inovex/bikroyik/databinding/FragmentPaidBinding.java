...
public final class FragmentPaidBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView paidFragment;

  private FragmentPaidBinding(@NonNull LinearLayout rootView, @NonNull RecyclerView paidFragment) {
  ...
  public static FragmentPaidBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.paidFragment;
      RecyclerView paidFragment = rootView.findViewById(id);
      if (paidFragment == null) {
        break missingId;
      }

      return new FragmentPaidBinding((LinearLayout) rootView, paidFragment);
    }
