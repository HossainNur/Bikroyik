...
public final class ActivityStockBinding implements ViewBinding {
  ...
  @NonNull
  public final ToolbarStockBinding tBarSales;
  ...
  private ActivityStockBinding(@NonNull ConstraintLayout rootView, @NonNull View horizontalLine,
      ...
      @NonNull ToolbarStockBinding tBarSales, @NonNull TextView tvListGridProductsSales,
  ...
  public static ActivityStockBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ToolbarStockBinding binding_tBarSales = ToolbarStockBinding.bind(tBarSales);
      ...
      return new ActivityStockBinding((ConstraintLayout) rootView, horizontalLine, imgListGridSales,
