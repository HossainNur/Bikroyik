...
public final class ActivityRentBinding implements ViewBinding {
  ...
  @NonNull
  public final ToolbarRentBinding toolbar1;

  private ActivityRentBinding(@NonNull RelativeLayout rootView, @NonNull ImageView addExpenseImage,
      ...
      @NonNull ToolbarRentBinding toolbar1) {
  ...
  public static ActivityRentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ToolbarRentBinding binding_toolbar1 = ToolbarRentBinding.bind(toolbar1);

      return new ActivityRentBinding((RelativeLayout) rootView, addExpenseImage, datePickerButton,
