...
public final class NotificationListRowBinding implements ViewBinding {
  ...
  private NotificationListRowBinding(@NonNull RelativeLayout rootView, @NonNull ImageView ivDetails,
      @NonNull ImageView ivListIcon, @NonNull TextView tvNotificationDate,
      @NonNull TextView tvNotificationDescription, @NonNull TextView tvNotificationType,
      @NonNull TextView tvVLine) {
  ...
  @NonNull
  public static NotificationListRowBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static NotificationListRowBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.notification_list_row, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static NotificationListRowBinding bind(@NonNull View rootView) {
    // The body of this method is generated in a way you would not otherwise write.
    // This is done to optimize the compiled bytecode for size and performance.
    int id;
    missingId: {
      id = R.id.ivDetails;
      ImageView ivDetails = rootView.findViewById(id);
      if (ivDetails == null) {
        break missingId;
      }

      id = R.id.ivListIcon;
      ImageView ivListIcon = rootView.findViewById(id);
      if (ivListIcon == null) {
        break missingId;
      }
      ...
      return new NotificationListRowBinding((RelativeLayout) rootView, ivDetails, ivListIcon,
          tvNotificationDate, tvNotificationDescription, tvNotificationType, tvVLine);
    }
