...
public final class ActivityOrderItemBinding implements ViewBinding {
  ...
  private ActivityOrderItemBinding(@NonNull ConstraintLayout rootView, @NonNull TextView chargeText,
  ...
  @NonNull
  public static ActivityOrderItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityOrderItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_order_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityOrderItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityOrderItemBinding((ConstraintLayout) rootView, chargeText, horizontalLine,
