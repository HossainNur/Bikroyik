...
public final class FragmentContactsBinding implements ViewBinding {
  ...
  private FragmentContactsBinding(@NonNull LinearLayout rootView,
      @NonNull RecyclerView contactsRecycler) {
  ...
  public static FragmentContactsBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.contacts_recycler;
      RecyclerView contactsRecycler = rootView.findViewById(id);
      if (contactsRecycler == null) {
        break missingId;
      }

      return new FragmentContactsBinding((LinearLayout) rootView, contactsRecycler);
    }
