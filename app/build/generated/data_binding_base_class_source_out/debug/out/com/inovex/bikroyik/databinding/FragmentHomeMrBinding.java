...
public final class FragmentHomeMrBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentHomeMrBinding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static FragmentHomeMrBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentHomeMrBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_home_mr, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentHomeMrBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentHomeMrBinding((LinearLayout) rootView, viewPagerCountDots,
