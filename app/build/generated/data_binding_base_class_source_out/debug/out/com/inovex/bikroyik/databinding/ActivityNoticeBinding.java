...
public final class ActivityNoticeBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView recyclerNoticeActivity;

  @NonNull
  public final ToolbarMeetingBinding tbToolbarMeeting;

  private ActivityNoticeBinding(@NonNull LinearLayout rootView,
      @NonNull RecyclerView recyclerNoticeActivity,
      @NonNull ToolbarMeetingBinding tbToolbarMeeting) {
    this.rootView = rootView;
    this.recyclerNoticeActivity = recyclerNoticeActivity;
  ...
  public static ActivityNoticeBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.recycler_noticeActivity;
      RecyclerView recyclerNoticeActivity = rootView.findViewById(id);
      if (recyclerNoticeActivity == null) {
        break missingId;
      }
      ...
      return new ActivityNoticeBinding((LinearLayout) rootView, recyclerNoticeActivity,
          binding_tbToolbarMeeting);
    }
